...
H_INITIAL = [0x21fba37b, 0x43ab9fb6, 0x75a9f91d, 0x86305019, 0xd7cd8173, 0x07fe00ff, 0x379f513f, 0x66b651a8, 0x764ab842]
K_CONSTANTS = [0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1, 0x923f82a4, 0xab1c5ed5, 0xd807aa98, 0x12835b01, 0x243185be, 0x550c7dc3, 0x72be5d74, 0x80deb1fe, 
...
uint32_t sigma1(uint32_t x) {
    return rotr32(x, 3) ^ rotr32(x, 19) ^ rotr32(x, 33);
}
